...
def proto_dis_loss(v, r1 ,r2, balance_weight):

    con_loss = 1 - F.cosine_similarity(r1, r2)
    proto_loss = F.kl_div(v, r1, reduction="batchmean") + F.kl_div(v, r2 , reduction="batchmean")
    loss = (1 - balance_weight) * proto_loss + balance_weight * con_loss
    return loss
